...
Bento has three different layouts `bento`, `lists` & `buttons`. It allows you to customize your experience giving you more buttons or lists depending on how are you more comfortable. To modify the layout you need to change the following line in the `config.js` file:
